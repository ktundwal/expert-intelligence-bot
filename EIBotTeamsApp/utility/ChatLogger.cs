...
namespace Microsoft.Office.EIBot.Service.utility
{
    ...
    /// </remarks>
    public class ActivityTableLogger : IActivityLogger, IActivitySource, IActivityManager
    {
        /// <summary>
        ...
        public class ActivityEntity : TableEntity
        {
            ...
            public override IDictionary<string, EntityProperty> WriteEntity(OperationContext operationContext)
            {
                ...
                props["ActivityJson"] = new EntityProperty(JsonConvert.SerializeObject(Activity));
        ...
        public ActivityTableLogger(CloudTable table)
        {
...
#pragma warning restore CS1998,CS4014
            ...
            return table.ExecuteAsync(insert).ContinueWith(t =>
            {
                if (--retriesLeft > 0 && t.IsFaulted)
                {
                    ...
                    if (response != null && response.StatusCode == System.Net.HttpStatusCode.Conflict)
                    {
                        ...
                        return ActivityTableLogger.Write(table, activity, retriesLeft);
                    }
                }
                t.Wait();
                return t;
    ...
    public class TableLoggerModule : Module
    {
        ...
        /// <summary>
        /// Create a ActivityTableLogger for a particular storage account and table name.
        /// </summary>
        ...
        /// <summary>
        /// Update builder with registration for ActivityTableLogger.
        /// </summary>
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.Register(c =>
            {
                ...
                .AsSelf()
                .SingleInstance();
            builder.RegisterType<ActivityTableLogger>()
